...
import ArticleListPage, { ArticlesListPageProps } from './ArticlesListPage';

describe('<ArticleListPage />', () => {
  const defaultProps: ArticlesListPageProps = {
  ...
  it('Renders article items', () => {
    const wrapper = shallow(<ArticleListPage {...defaultProps} />);
    expect(wrapper.find('[data-test="articles-list-container"]').children()).toHaveLength(4);
  })
});
